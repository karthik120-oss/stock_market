...
VOLUME_EMA_SHORT = 9   # Changed to 9 days for more responsive volume signals
VOLUME_EMA_LONG = 21   # Changed to 21 days for volume trend
...
def analyze_volume_trend(stock_data, use_today=True):
    ...
    # Calculate Chaikin Oscillator using updated EMA periods
